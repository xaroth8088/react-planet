...
export default class PlanetTexture {
    ...
    update = () => {
        ...
        const { width, height, cloud, iterator, surfaceHeight, surfaceColor, diffuse, specular, normal, params } = this;

        const next = iterator.next();

        const { x, y } = next;
        const { waterLevel, waterFalloff, waterDeep, waterShallow, waterSpecular, cloudNoise, spin, cloudOpacity, cloudColor } = params;
