...
export default class PlanetTexture {
    ...
    update() {
        ...
        if (c0 > this.params.waterLevel) {
            ...
            const n = Vector.create([dr / (this.width - 1), 0, (cx - c0)]).cross(Vector.create([0, dr / (this.height - 1), (cy - c0)])).toUnitVector();
            const rgb = normalRGBA(n.elements[0], -n.elements[1], n.elements[2]);
