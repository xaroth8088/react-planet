...
export default class PlanetRenderer {
    ...
    init(
        ...
        const textureHeight = resolution / 2.0;
        this.diffuse = new DataTexture(diffusePixels, textureWidth, textureHeight, RGBAFormat, UnsignedByteType);
        ...
        this.normal = new DataTexture(normalPixels, textureWidth, textureHeight, RGBAFormat, UnsignedByteType);
        this.normal.wrapS = RepeatWrapping;
        this.normal.needsUpdate = true;

        this.specular = new DataTexture(specularPixels, textureWidth, textureHeight, RGBAFormat, UnsignedByteType);
        ...
        this.cloud = new DataTexture(cloudPixels, textureWidth, textureHeight, RGBAFormat, UnsignedByteType);
