...
export default class Application {
    ...
    async init() {
        ...
        await surfaceNoise.init(0, parseInt(this.config.resolution, 10));
        ...
        this.planetTexture = {
            diffuse: {
                pixels: surfaceNoise.diffusePixels,
                width,
                height
            },
            normal: {
                pixels: surfaceNoise.normalPixels,
                width,
                height
            },
            specular: {
                pixels: surfaceNoise.specularPixels,
                width,
                height
            },
            cloud: {
                pixels: surfaceNoise.cloudPixels,
                width,
                height
            },
            done: false
