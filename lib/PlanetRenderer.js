import { PerspectiveCamera, IcosahedronGeometry, Scene, Object3D, Mesh, MeshPhongMaterial, DirectionalLight, WebGLRenderer, Texture, RepeatWrapping, Vector2 } from 'three';
...
export default class PlanetRenderer {
    constructor() {
        ...
        this.planetMesh = new Mesh(new IcosahedronGeometry(1, 5), material);
        this.planet.add(this.planetMesh);

        this.cloudMesh = new Mesh(new IcosahedronGeometry(1.001, 5), material);
