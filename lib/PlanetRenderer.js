...
export default class PlanetRenderer {
    ...
    init(
        ...
        this.diffuse = new DataTexture(diffusePixels, textureWidth, textureHeight, RGBFormat, UnsignedByteType);
        ...
        this.normal = new DataTexture(normalPixels, textureWidth, textureHeight, RGBFormat, UnsignedByteType);
        this.normal.wrapS = RepeatWrapping;
        this.normal.needsUpdate = true;

        this.specular = new DataTexture(specularPixels, textureWidth, textureHeight, RGBFormat, UnsignedByteType);
